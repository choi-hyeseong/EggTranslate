...
class ImageController(private val imageService: ImageService) {
    ...
    //분리가능
    @PostMapping("/upload")
    suspend fun uploadImage(@RequestParam id : Long, @ImageValid @RequestParam(name = "image", required = true) image : List<MultipartFile>, @LangValid @RequestParam(name = "lang", required = true) lang : String) : Response<AutoTranslateResponseDTO> {
