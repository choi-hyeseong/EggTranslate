...
class ImageController(private val imageService: ImageService) {
    ...
    suspend fun uploadImage(
        ...
        @ImageValid @RequestParam(name = "image", required = true) image: List<MultipartFile>,
        @LangValid @RequestParam(name = "lang", required = true) lang: String
    ): Response<TranslateResultResponseDTO> {
        //withContext로 dispatcher 지정해도 안전.
        return Response.ofSuccess(null, imageService.handleImage(id, null, lang, image))
    }
